...
<?php
	...
	if($_SESSION['user_type'] == "sponsor" || $_SESSION['user_type'] == "admin"){
		...
		$query = "select date_created, point_amount points_history join sponsors on sponsors.user_id = point_history.sponsor_id where driver_id = '".$_SESSION['user_id']."' ORDER BY date_created ASC;";
