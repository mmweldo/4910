...
<?php
	...
	if($_SESSION['user_type'] == "sponsor" || $_SESSION['user_type'] == "admin"){
		...
		$query = "SELECT date_created, point_amount FROM points_history JOIN sponsors ON sponsors.user_id = points_history.sponsor_id WHERE driver_id = '".$_SESSION['user_id']."' ORDER BY date_created ASC;";
