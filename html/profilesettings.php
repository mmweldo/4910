                      ...
                      <fieldset>
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
							   	<?php
									$sql = "select firstname from drivers where user_id = ".$_SESSION['user_id'];
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
								<?php
									$sql = "select lastname from drivers where user_id = ".$_SESSION['user_id'];
									$result = mysqli_query($conn, $sql);
									$row = mysqli_fetch_row($result);
							    ?>							
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
								<?php
									$sql = "select street_address from drivers where user_id = ".$_SESSION['user_id'];
									$result = mysqli_query($conn, $sql);
									$row = mysqli_fetch_row($result);
							    ?>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
								<?php
									$sql = "select postal_code from drivers where user_id = ".$_SESSION['user_id'];
									$result = mysqli_query($conn, $sql);
									$row = mysqli_fetch_row($result);
							    ?>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
								<?php
									$sql = "select country from drivers where user_id = ".$_SESSION['user_id'];
									$result = mysqli_query($conn, $sql);
									$row = mysqli_fetch_row($result);
							    ?>
