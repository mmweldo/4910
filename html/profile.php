				...
				<div class="profile-userbuttons">
					...
					<?php
						...
						if(isset($_SESSION['user_id']) && $_SESSION['user_type'] == "driver"){
							echo '<form style="color:white;"class="application-form" method="post" action="index.php"><input type="hidden" type="text" name="username" placeholder="username" value="'.$_POST['username'].'"><input type="hidden" type="text" name="user_id" placeholder="user_id" value="'.$_POST['user_id'].'"><button class="btn btn-info btn-sm" type="View" name="submit"><a style="color:white;"><i style="color:white;" class="glyphicon glyphicon-road"></i> Apply </a></button></form>';
						}
					?>
				</div>
				<!-- END SIDEBAR BUTTONS -->
