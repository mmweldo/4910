<?php  
	...
	echo "INSERT INTO driver_list (sponsor_id, driver_id, driver_username) VALUES ((SELECT sponsor_id FROM sponsors WHERE company_name = ".$_POST['company_name']."), (SELECT driver_id FROM drivers WHERE username = ".$_POST['username']."), ".$_POST['username'].");";
	$result = mysqli_query($conn, $query);
	if(!$result){
