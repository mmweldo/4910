...
if(isset($_POST['querysubmit'])){
  ...
  // echo "</pre>";
      ...
      */
      $results .= "<div class='container' style=''><ul id='stories'>";
      $results .= "<li><h3 class='page-title'><a href='$link\' target='blank'>$title</a></h3><img src=\"$pic\" style='max-width: 100%;margin:1%;'><h3>Price $$price  </h3></div></li>";
