...
?>
  <a style="position:relative; left:0px; float:left;" href="/storeconnector.php"><button class="btn btn-success btn-sm">Store</button></a>
  <center>
...
if(isset($_POST['querysubmit'])){
  ...
  // echo "</pre>";
      ...
      */
      $results .= "<center><div style='width: 30vw; height: 20vh; min-width: 30vw; min-height: 20vh; max-width: 30vw; max-height: 20vh;'><ul style='text-align: center;' id='stories'>";
